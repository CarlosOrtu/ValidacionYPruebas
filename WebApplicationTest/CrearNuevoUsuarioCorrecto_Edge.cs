...
{
    //Mismo metodo que CrearNuevoUsuarioCorrecto_Chrome pero esta vez ejecutado desde Edge
    [TestClass]
    public class CrearNuevoUsuarioCorrecto_Edge
    {
        ...
        public void TheCrearNuevoUsuarioCorrectoTest()
        {
            ...
            driver.FindElement(By.Id("NewTBUserName")).SendKeys("Carlos2");
            ...
            driver.FindElement(By.Id("TBUsername")).SendKeys("Carlos2");
            ...
            try
            {
                Assert.AreEqual("Carlos2", driver.FindElement(By.Id("lblUserName")).Text);
            }
            catch (Exception e)
            {
                verificationErrors.Append(e.Message);
